        ...
        <div class="row">
            ...
            <div class="col-md-3 mt-20">
                <div class="form-group">
                    ...
                    <input class="form-control" type="color" name="user_background_color" value="{{ (!empty($settings['user_background_color']))?$settings['user_background_color'] : '#ffffff'}}"/>
                </div>
            </div>
            <div class="col-md-3 mt-20">
                <div class="form-group">
                    <label for="">{{__('Background Color Trade')}}</label>
                    <input class="form-control" type="color" name="user_background_color_trade" value="{{ (!empty($settings['user_background_color_trade']))?$settings['user_background_color_trade'] : '#ffffff'}}"/>
                </div>
            </div>
            <div class="col-md-3 mt-20">
                <div class="form-group">

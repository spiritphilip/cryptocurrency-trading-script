                        ...
                        <div class="row">
                            <div class="col-xl-4 mb-xl-0 mb-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="feature_title" class="form-control" @if(isset($item)) value="{{$item->feature_title}}" @else value="{{old('feature_title')}}" @endif>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div id="file-upload" class="section-width">
                                                <input type="file" placeholder="0.00" name="feature_icon"
